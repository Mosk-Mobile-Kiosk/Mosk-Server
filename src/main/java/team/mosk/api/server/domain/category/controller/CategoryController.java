...
public class CategoryController {
    ...
    public ResponseEntity<SimpleCategoryResponse> create(@RequestBody CreateCategoryRequest request,
    ...
    public ResponseEntity<Void> delete(@RequestParam(name = "categoryId") Long categoryId,
                                       @AuthenticationPrincipal CustomUserDetails userDetails) {
    ...
    public ResponseEntity<SimpleCategoryResponse> update(@RequestBody UpdateCategoryRequest request,
                                                         @AuthenticationPrincipal CustomUserDetails userDetails) {
